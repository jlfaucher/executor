...
In all cases, the corresponding codepoint is used.
...
When transcoding to a Byte encoding, if the replacement character is a
UnicodeCharacter then its codepoint must be a valid target codepoint.
