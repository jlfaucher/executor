...
set OR_OODIALOGSRCW=%SRC_DRV%%SRC_DIR%\extensions\platform\windows\oodialog.wchar
...
set OR_ORYXINCLB=%OR_ORYXINCL% -I%OR_OODIALOGSRCW%\
set OR_ORYXINCLW=%OR_ORYXINCL% -I%OR_OODIALOGSRCW%\
