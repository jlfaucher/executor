...
set CLASSES_SUPPORT_M17N=%INTERPRETER%\classes\support\m17n
set CLASSES_SUPPORT_M17N_CHARSET=%INTERPRETER%\classes\support\m17n\charset
set CLASSES_SUPPORT_M17N_ENCODING=%INTERPRETER%\classes\support\m17n\encoding
...
set OR_INTERPRETERINCL=-I%INTERPRETER%\ -I%INTERPRETER_CLASSES%\ -I%CLASSES_SUPPORT%\ -I%CLASSES_SUPPORT_M17N% -I%INTERPRETER_RUNTIME%\ -I%BEHAVIOUR%\ -I%CONCURRENCY%\ -I%EXECUTION%\ -I%MEMORY%\ -I%PACKAGE%\ -I%EXPRESSIONS%\ -I%INSTRUCTIONS%\ -I%PARSER%\ -I%INT_PLATFORM%\ -I%STREAM%\ -I%INTERPRETER_MESSAGES%\
REM
REM set up the directory search orders for the source include files
REM
set OR_ORYXINCL=-I%OR_LIBSRC%\ -I%OR_COMMONSRC%\ -I%OR_COMMONPLATFORMSRC%\ -I%OR_APISRC%\ -I%OR_APIWINSRC%\ %OR_INTERPRETERINCL% -I%OR_WINKERNELSRC%\ -I%XPLATFORM% -I%OR_OODIALOGSRC%\ -I%OR_OLEOBJECTSRC%\ -I%OR_ORXSCRIPTSRC%\ -I%OR_MESSAGESRC%\ -I%OR_HOSTEMUSRC%\
