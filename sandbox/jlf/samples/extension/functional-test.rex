...
"The quick brown fox jumps over the lazy dog"~mapword{translation~arg(1)}~dump
.MutableBuffer~new("The quick brown fox jumps over the lazy dog")~mapword({translation[arg(1)]}, .false)~dump
*/

-- A source can be tagged explicitely as a routine (but you don't need that, because it's the default)
.Array~of(1,2,3,4)~map{::routine arg(1) * 2}~dump -- an Array : 2, 4, 6, 8
...
colors~map{::method self~rgbInteger "("self~redIntensity", "self~greenIntensity", "self~blueIntensity")"}~dump -- an Array : 0 (0, 0, 0), 255 (0, 0, 255), 32768 (0, 128, 0), 12500670 (190, 190, 190)
