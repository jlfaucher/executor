...
usage:
    ...
    .error~say("Usage:")
    .error~say("    "scriptname" [-h | --help] [-fo | --force-overwrite] [-fu | --force-update] [-nl1 | --no-level-1] [-v | --verbose] [--] [inputname [outputname]]")
    .error~say("    where")
    ...
    .error~say("        -nl1 --no-level-1       don't number the titles at level 1")
    .error~say("        -v   --verbose          activates the verbose mode")
    .error~say("        -h   --help             shows help")
