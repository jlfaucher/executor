...
<!--
JLF : This file has been modified to work directly on a syntax diagram (i.e.
the input file is no longer an XML generated by the Dita toolkit).
All tests "contains(@class, ...) have been replaced by "name() = ...)
-->
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:template name="syntaxdiagram2svg:root">
        ...
        <svg:g class="diagram" syntaxdiagram2svg:dispatch="diagram">
            ...
            <xsl:message>apply-templates#1 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    ...
    <xsl:template match="*" mode="syntaxdiagram2svg:top-level-walk">
        <xsl:message>match#1 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:message>apply-templates#2 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:apply-templates select="." mode="syntaxdiagram2svg:top-level"/>
        <xsl:message>apply-templates#3 on <xsl:value-of select="name(following-sibling::*[1])"/></xsl:message>
    ...
    <xsl:template
        match="*[name() = 'syntaxdiagram'
        or name() = 'synblk'
        or name() = 'fragment']"
        mode="syntaxdiagram2svg:top-level-walk">
        <xsl:message>match#2 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    </xsl:template>

    <!-- Top-level items. -->
    <xsl:template match="*" mode="syntaxdiagram2svg:top-level">
        <xsl:message>match#3 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:choose>
            <xsl:when
                test="name() = 'synnote'
                or name() = 'synnoteref'
                ...
                <xsl:message>apply-templates#4 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
            ...
            <xsl:otherwise>
                ...
                <xsl:message>apply-templates#5 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    ...
    <xsl:template
        ...
        <xsl:message>match#4 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:choose>
            <xsl:when test="*[name() = 'repsep']">
                ...
                <svg:g class="groupseq" syntaxdiagram2svg:dispatch="loop">
                    ...
                    <xsl:if test="*[name() = 'repsep']/node()">
                        <xsl:message>apply-templates#6 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                        <xsl:apply-templates select="*[name() = 'repsep']"
                            mode="syntaxdiagram2svg:default">
                            <xsl:with-param name="role" select="'repsep'"/>
                        </xsl:apply-templates>
                    </xsl:if>
                    <xsl:message>apply-templates#7 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                    <xsl:apply-templates select="." mode="syntaxdiagram2svg:ignore-repsep"/>
                </svg:g>
            </xsl:when>
            <xsl:otherwise>
                <xsl:message>apply-templates#8 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                <xsl:apply-templates select="." mode="syntaxdiagram2svg:ignore-repsep">
    ...
    <xsl:template
        ...
        <!-- not used <xsl:param name="compact"/> -->
        <xsl:param name="role" select="'forward'"/>
        <xsl:message>match#5 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:choose>
            <!-- Default importance has already been handled by parent groupchoice. -->
            <xsl:when test="@importance='default'">
                <xsl:message>apply-templates#9 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
            ...
            <xsl:otherwise>
                <xsl:message>apply-templates#10 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                <xsl:apply-templates select="." mode="syntaxdiagram2svg:default">
                    <xsl:with-param name="role" select="$role"/>
                </xsl:apply-templates>
            </xsl:otherwise>
    ...
    <xsl:template
        ...
        <!-- not used <xsl:param name="compact"/> -->
        <xsl:param name="role" select="'forward'"/>
        <xsl:message>match#6 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:choose>
            <xsl:when test="@importance = 'optional'">
                ...
                <svg:g class="groupseq" syntaxdiagram2svg:dispatch="decision">
                    ...
                    <xsl:message>apply-templates#11 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                    <xsl:apply-templates select="." mode="syntaxdiagram2svg:body-only">
            ...
            <xsl:when test="@importance = 'default'">
                ...
                <svg:g class="groupseq" syntaxdiagram2svg:dispatch="decision">
                    ...
                    <svg:g syntaxdiagram2svg:dispatch="void" syntaxdiagram2svg:role="straight"/>
                    <xsl:message>apply-templates#12 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                    <xsl:apply-templates select="." mode="syntaxdiagram2svg:body-only">
            ...
            <xsl:otherwise>
                <xsl:message>apply-templates#13 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                <xsl:apply-templates select="." mode="syntaxdiagram2svg:body-only">
                    <!-- not used <xsl:with-param name="compact" select="$compact"/> -->
                    <xsl:with-param name="role" select="$role"/>
                </xsl:apply-templates>
    ...
    <xsl:template match="*[name() = 'groupchoice']"
        mode="syntaxdiagram2svg:ignore-repsep">
        <xsl:param name="role" select="'forward'"/>
        <xsl:message>match#7 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:choose>
            <!-- If only one choice, this isn't a choice at all. -->
            <xsl:when
                test="(not(@importance) or @importance = 'required') and count(*[not(name() = 'repsep') and not(name() = 'title')]) = 1">
                <xsl:call-template name="syntaxdiagram2svg:append-notes">
                    <xsl:with-param name="contents">
                       <xsl:message>apply-templates#14 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                        <xsl:apply-templates
                            select="*[not(name() = 'repsep') and not(name() = 'title')]"
                            mode="syntaxdiagram2svg:default">
                            <xsl:with-param name="role" select="$role"/>
                        </xsl:apply-templates>
                    </xsl:with-param>
                        ...
                        <svg:g class="groupchoice" syntaxdiagram2svg:dispatch="decision">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="@importance = 'optional'">
                                    ...
                                    <xsl:message>apply-templates#15 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                                    <xsl:apply-templates
                                        select="*[not(name() = 'repsep') and not(name() = 'title')][@importance = 'default']"
                                        mode="syntaxdiagram2svg:groupchoice-child">
                                        <xsl:with-param name="role" select="'upward'"/>
                                    </xsl:apply-templates>
                                    <xsl:message>apply-templates#16 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                                    <xsl:apply-templates
                                        select="*[not(name() = 'repsep') and not(name() = 'title')][not(@importance = 'default')]"
                                        mode="syntaxdiagram2svg:groupchoice-child">
                                        <xsl:with-param name="role" select="'downward'"/>
                                    </xsl:apply-templates>
                                </xsl:when>
                                ...
                                <xsl:when test="@importance = 'default'">
                                    ...
                                    <xsl:message>apply-templates#17 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                                    <xsl:apply-templates
                                        select="*[not(name() = 'repsep') and not(name() = 'title')][1]"
                                        mode="syntaxdiagram2svg:groupchoice-child">
                                        <xsl:with-param name="role" select="'upward'"/>
                                    </xsl:apply-templates>
                                    <xsl:message>apply-templates#18 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                                    <xsl:apply-templates
                                        select="*[not(name() = 'repsep') and not(name() = 'title')][position() != 1]"
                                        mode="syntaxdiagram2svg:groupchoice-child">
                                        <xsl:with-param name="role" select="'downward'"/>
                                    </xsl:apply-templates>
                                </xsl:when>
                                ...
                                <xsl:otherwise>
                                    <xsl:message>apply-templates#19 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                                    <xsl:apply-templates
                                        select="*[not(name() = 'repsep') and not(name() = 'title')][@importance = 'default']"
                                        mode="syntaxdiagram2svg:groupchoice-child">
                                        <xsl:with-param name="role" select="'upward'"/>
                                    ...
                                    <xsl:message>apply-templates#20 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                                    <xsl:apply-templates
                                        select="*[not(name() = 'repsep') and not(name() = 'title')][not(@importance = 'default')][1]"
                                        mode="syntaxdiagram2svg:groupchoice-child">
                                        <xsl:with-param name="role" select="'straight'"/>
                                    </xsl:apply-templates>
                                    <xsl:message>apply-templates#21 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                                    <xsl:apply-templates
                                        select="*[not(name() = 'repsep') and not(name() = 'title')][not(@importance = 'default')][position() &gt; 1]"
                                        mode="syntaxdiagram2svg:groupchoice-child">
                                        <xsl:with-param name="role" select="'downward'"/>
                                    </xsl:apply-templates>
                                </xsl:otherwise>
    ...
    <xsl:template match="*[name() = 'groupseq']" mode="syntaxdiagram2svg:body-only">
        <xsl:param name="role" select="'forward'"/>

        <xsl:message>match#8 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    ...
    <xsl:template match="*[name() = 'groupcomp']" mode="syntaxdiagram2svg:body-only">
        <xsl:param name="role" select="'forward'"/>

        <xsl:message>match#9 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:choose>
            <xsl:when
                test="descendant::*[*[name() = 'repsep']
                or name() = 'groupchoice'
                or @importance = 'optional'
                or @importance = 'default']">
        ...
        <xsl:call-template name="syntaxdiagram2svg:append-notes">
            <xsl:with-param name="contents">
                <svg:g class="groupseq" syntaxdiagram2svg:dispatch="sequence">
                    ...
                    <xsl:message>apply-templates#22 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                    <xsl:apply-templates
                        select="*[not(name() = 'title' or name() = 'repsep')]"
                        mode="syntaxdiagram2svg:default"/>
                </svg:g>
            </xsl:with-param>
            <xsl:with-param name="role" select="$role"/>
        ...
        <xsl:call-template name="syntaxdiagram2svg:append-notes">
            <xsl:with-param name="contents">
                <svg:g class="boxed groupcomp" syntaxdiagram2svg:dispatch="boxed">
                    ...
                    <xsl:message>apply-templates#23 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                    <xsl:apply-templates
                        select="*[not(name() = 'title' or name() = 'repsep')]"
    ...
    <xsl:template match="*" mode="syntaxdiagram2svg:groupchoice-child">
        <xsl:param name="role"/>
        <xsl:message>match#10 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:message>apply-templates#24 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:apply-templates select="." mode="syntaxdiagram2svg:default">
            <xsl:with-param name="role" select="$role"/>
        </xsl:apply-templates>
    </xsl:template>
    ...
    <xsl:template
        ...
        <xsl:message>match#11 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:message>apply-templates#25 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    ...
    <xsl:template
        ...
        mode="syntaxdiagram2svg:default">
        <xsl:param name="role" select="'forward'"/>
        <xsl:message>match#12 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:choose>
            ...
            <xsl:when test="@importance = 'optional'">
                <svg:g syntaxdiagram2svg:dispatch="decision">
                    ...
                    <svg:g syntaxdiagram2svg:dispatch="void" syntaxdiagram2svg:role="straight"/>
                    <xsl:message>apply-templates#26 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                    <xsl:apply-templates select="." mode="syntaxdiagram2svg:body-only">
                        <xsl:with-param name="role" select="'downward'"/>
                    </xsl:apply-templates>
                </svg:g>
            ...
            <xsl:when test="@importance = 'default'">
                <svg:g syntaxdiagram2svg:dispatch="decision">
                    ...
                    <svg:g syntaxdiagram2svg:dispatch="void" syntaxdiagram2svg:role="straight"/>
                    <xsl:message>apply-templates#27 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                    <xsl:apply-templates select="." mode="syntaxdiagram2svg:body-only">
                        <xsl:with-param name="role" select="'upward'"/>
                    </xsl:apply-templates>
                </svg:g>
            ...
            <xsl:otherwise>
                <xsl:message>apply-templates#28 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                <xsl:apply-templates select="." mode="syntaxdiagram2svg:body-only">
                    <xsl:with-param name="role" select="$role"/>
                </xsl:apply-templates>
            </xsl:otherwise>
    ...
    <xsl:template
        ...
        mode="syntaxdiagram2svg:groupchoice-child">
        <xsl:param name="role" select="'forward'"/>
        <xsl:message>match#13 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:choose>
            ...
            <xsl:when test="@importance = 'optional'">
                <svg:g syntaxdiagram2svg:dispatch="decision">
                    ...
                    <svg:g syntaxdiagram2svg:dispatch="void" syntaxdiagram2svg:role="straight"/>
                    <xsl:message>apply-templates#29 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                    <xsl:apply-templates select="." mode="syntaxdiagram2svg:body-only">
                        <xsl:with-param name="role" select="'downward'"/>
                    </xsl:apply-templates>
                </svg:g>
            ...
            <xsl:otherwise>
                <xsl:message>apply-templates#30 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                <xsl:apply-templates select="." mode="syntaxdiagram2svg:body-only">
                    <xsl:with-param name="role" select="$role"/>
                </xsl:apply-templates>
            </xsl:otherwise>
    ...
    <xsl:template
        ...
        <xsl:param name="role" select="'forward'"/>
        <xsl:message>match#14 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:call-template name="syntaxdiagram2svg:append-notes">
            <xsl:with-param name="contents">
                <svg:g syntaxdiagram2svg:dispatch="boxed">
                    ...
                    <xsl:message>Call 1 to syntaxdiagram2svg:box-contents</xsl:message>
    ...
    <xsl:template
        ...
        <xsl:message>match#15 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <svg:g syntaxdiagram2svg:dispatch="unboxed" syntaxdiagram2svg:role="forward">
            ...
            <xsl:message>Call 2 to syntaxdiagram2svg:box-contents</xsl:message>
            <xsl:call-template name="syntaxdiagram2svg:box-contents"/>
        </svg:g>
    </xsl:template>
    ...
    <xsl:template name="syntaxdiagram2svg:box-contents">
        <xsl:message>syntaxdiagram2svg:box-contents : <xsl:value-of select="name()"/></xsl:message>
        <xsl:choose>
            <xsl:when test="node()">
                <xsl:message>apply-templates#31 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    ...
    <xsl:template match="*[name() = 'desc']" mode="syntaxdiagram2svg:box-contents">
        <!-- Do nothing.  This shouldn't be there but topicpull wants to put a desc on all xrefs. -->
        <xsl:message>match#17 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    </xsl:template>

    <!-- Need this if topicpull hasn't been run. -->
    <xsl:template name="syntaxdiagram2svg:get-href">
        <xsl:message>Entering in syntaxdiagram2svg:get-href</xsl:message>
        <xsl:choose>
            <xsl:when test="contains(@href, '#')">
                ...
                <xsl:choose>
                    <xsl:when test="contains(substring-after(@href, '#'), '/')">
                        ...
                        <!--
                        <xsl:apply-templates
                            select="document($document, /)//*[name() = 'topic'][@id = $topicid]//*[not(name() = 'topic')][@id = $targetid]/*[name() = 'title']/node()"
                            mode="syntaxdiagram2svg:box-contents"/>
                        -->
                        <xsl:message>apply-templates#32 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                        <xsl:apply-templates
                            select="document($document, /)//*[@id = $topicid]//*[@id = $targetid]/*[name() = 'title']/node()"
                            mode="syntaxdiagram2svg:box-contents"/>
                    </xsl:when>
                    <xsl:otherwise>
                        ...
                        <!--
                        <xsl:apply-templates
                            select="document($document, /)//*[name() = 'topic'][@id = $topicid]/*[name() = 'title']/node()"
                            mode="syntaxdiagram2svg:box-contents"/>
                        -->
                        <xsl:message>Searching for topicid=<xsl:value-of select="$topicid"/></xsl:message>
                        <xsl:for-each select="document($document, /)//*[@id = $topicid]/*[name() = 'title']">
                            <xsl:message>    Found <xsl:value-of select="concat(name(..), '/', name(.))"/> : <xsl:value-of select="."/></xsl:message>
                        </xsl:for-each>
                        <xsl:message>apply-templates#33 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                        <xsl:apply-templates
                            select="document($document, /)//*[@id = $topicid]/*[name() = 'title']"
                            mode="syntaxdiagram2svg:box-contents"/>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:when>
            <xsl:otherwise>
                <!--
                <xsl:apply-templates
                    select="document(@href, /)//*[name() = 'topic'][1]/*[name() = 'title']/node()"
                    mode="syntaxdiagram2svg:box-contents"/>
                -->
                <xsl:message>apply-templates#34 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                <xsl:apply-templates
                    select="document(@href, /)//*[1]/*[name() = 'title']/node()"
                    mode="syntaxdiagram2svg:box-contents"/>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>

    <xsl:template match="*[name() = 'repsep']" mode="syntaxdiagram2svg:default">
        <xsl:message>match#18 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:choose>
            <xsl:when test="@importance = 'optional'">
                <svg:g syntaxdiagram2svg:dispatch="revdecision" syntaxdiagram2svg:role="repsep">
                    ...
                    <xsl:message>apply-templates#35 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                    <xsl:apply-templates select="." mode="syntaxdiagram2svg:body-only">
                        <xsl:with-param name="role" select="'downward'"/>
                    </xsl:apply-templates>
                </svg:g>
            ...
            <xsl:otherwise>
                <xsl:message>apply-templates#36 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                <xsl:apply-templates select="." mode="syntaxdiagram2svg:body-only">
                    <xsl:with-param name="role" select="'repsep'"/>
                </xsl:apply-templates>
            </xsl:otherwise>
    ...
    <xsl:template name="syntaxdiagram2svg:append-notes">
        ...
        <xsl:choose>
            <xsl:when
                test="following-sibling::*[1][name() = 'synnote'][not(@id)]
                | following-sibling::*[1][name() = 'synnoteref'][@href and @href != '']">
                <svg:g syntaxdiagram2svg:dispatch="notecontainer">
                    <xsl:attribute name="syntaxdiagram2svg:role">
                        <xsl:value-of select="$role"/>
                    </xsl:attribute>
                    <xsl:copy-of select="$contents"/>
                    <xsl:message>apply-templates#37 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
                    <xsl:apply-templates select="following-sibling::*[1]"
    ...
    <xsl:template match="*[name() = 'synnote'][not(@id)]"
        mode="syntaxdiagram2svg:note-walk">
        <xsl:message>match#18a for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:message>apply-templates#38 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:apply-templates select="." mode="syntaxdiagram2svg:note"/>
        <xsl:message>apply-templates#39 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:apply-templates select="following-sibling::*[1]" mode="syntaxdiagram2svg:note-walk"/>
    </xsl:template>

    <xsl:template match="*[name() = 'synnoteref'][@href and @href != '']"
        mode="syntaxdiagram2svg:note-walk">
        <xsl:message>match#19 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:message>apply-templates#40 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:apply-templates select="." mode="syntaxdiagram2svg:note"/>
        <xsl:message>apply-templates#41 on <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <xsl:apply-templates select="following-sibling::*[1]" mode="syntaxdiagram2svg:note-walk"/>
    </xsl:template>

    <xsl:template match="*" mode="syntaxdiagram2svg:note-walk">
        <xsl:message>match#20 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    </xsl:template>

    <xsl:template match="*[name() = 'synnote'][not(@id)]"
        mode="syntaxdiagram2svg:default">
        <xsl:message>match#21 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    </xsl:template>

    <xsl:template match="*[name() = 'synnote'][not(@id)]"
        mode="syntaxdiagram2svg:groupcomp-child">
        <xsl:message>match#22 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    ...
    <xsl:template match="*[name() = 'synnote'][not(@id)]"
        ...
        <xsl:message>match#23 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    ...
    <xsl:template match="*[name() = 'synnote'][@id]"
        mode="syntaxdiagram2svg:default"> 
        <xsl:message>match#24 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    </xsl:template>

    <xsl:template match="*[name() = 'synnote'][@id]"
        mode="syntaxdiagram2svg:groupcomp-child"> 
        <xsl:message>match#25 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    </xsl:template>
    ...
    <xsl:template name="syntaxdiagram2svg:get-callout">
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:number format="1" count="*[name() = 'fn']" from="/*" level="any"/>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
    ...
    <xsl:template match="*[name() = 'synnoteref'][@href and @href != '']"
        mode="syntaxdiagram2svg:default">
        <xsl:message>match#26 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
    </xsl:template>

    <xsl:template match="*[name() = 'synnoteref'][@href and @href != '']"
        mode="syntaxdiagram2svg:note">
        <xsl:message>match#27 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <svg:g syntaxdiagram2svg:dispatch="note" class="note">
            <svg:text>
    ...
    <xsl:template match="*[name() = 'synnoteref'][@href and @href != '']"
        mode="syntaxdiagram2svg:groupcomp-child">
        <xsl:message>match#28 for <xsl:value-of select="concat(name(.), ' ', @id)"/></xsl:message>
        <svg:g syntaxdiagram2svg:dispatch="note" class="note">
            <svg:text>
                <xsl:call-template name="syntaxdiagram2svg:get-callout-reference"/>
            </svg:text>
            ...
            <xsl:when test="contains(@href, '#')">
                ...
                <xsl:choose>
                    <xsl:when test="contains(substring-after(@href, '#'), '/')">
                        ...
                        <!--
                        <xsl:for-each
                            select="document($document, /)//*[name() = 'topic'][@id = $topicid]//*[name() = 'fn'][@id = $targetid]">
                            <xsl:call-template name="syntaxdiagram2svg:get-callout"/>
                        </xsl:for-each>
                        -->
                        <xsl:for-each
                            select="document($document, /)//*[@id = $topicid]//*[name() = 'fn'][@id = $targetid]">
                            <xsl:call-template name="syntaxdiagram2svg:get-callout"/>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
